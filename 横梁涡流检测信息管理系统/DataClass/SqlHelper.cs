...
namespace common
{
    ...
    {
        //public string costConnectionstr = "Data Source=localhost;Initial Catalog=CarMIS;User=sa;Password=sa";
        ...
        /// <returns></returns>
        public int ExecuteNonQuery(string str, List<SqlParameter> paramList)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection())
                {
                    sqlConnection.ConnectionString = GetConnSting();
                    sqlConnection.Open();
        ...
        public static int ExcuteSql(string sql, SqlParameter[] sps)
        {
            using (SqlConnection conn = new SqlConnection())
            {
                conn.ConnectionString = GetConnSting(); ;
                conn.Open();
                //新建执行sql对象
        ...
        public int ExcuteProcNonQuery(string procname, DbParameter[] pars)
        {
            ...
            {
                con.ConnectionString = GetConnSting(); ;
                con.Open();
                SqlCommand cmd = new SqlCommand();
        ...
        {
            return ConfigurationManager.ConnectionStrings["横梁涡流检测信息管理系统.Properties.Settings.FaultMISConnectionString"].ConnectionString;
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        public static int ExecuteNonQuery(string str, SqlParameter[] sql)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection())
        ...
        {
            // 执行参数为空的方法 
            return ExecuteScalar(GetConnSting(), CommandType.Text, commandText);
        }
        /// <summary> 
        /// 执行指定数据库连接字符串的命令,返回结果集中的第一行第一列. 
        /// </summary> 

...
{
    public partial class FormDETECTION_TECHNOLOGYInfo : Form
    {
        public string formName = "FormDETECTION_TECHNOLOGYInfo";
        string gs_carlist = "select dt.[DetectionTechnology_ID] as 检测技术编号,   dt.[Detection_Technology_NAME] as 检测技术名称 from DETECTION_TECHNOLOGY dt ";
       // RepairPRocessDao dao = new RepairPRocessDao();
        ...
        public FormDETECTION_TECHNOLOGYInfo()
        {
            InitializeComponent();

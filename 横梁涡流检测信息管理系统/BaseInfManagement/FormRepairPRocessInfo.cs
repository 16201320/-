...
{
    public partial class FormRepairPRocessInfo : Form
    {
        public string formName = "FormRepairPRocessInfo";
        string gs_carlist = "select ri.[REPAIR_ID] as 修程编号,   ri.[REPAIR_NAME] as 修程名称 from REPAIRPROCESS_INFO ri " ;
        ...
        private void 添加ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormRepairPRocessInfoEdit frm = new FormRepairPRocessInfoEdit(strOperationFlag, oneLineCarInfo);
                frm.Owner = this;
                frm.ShowDialog();
            ...
            {
                MessageBox.Show("添加修程信息时发生错误！" + ex.Message, "提示信息");
                return;
            }
        }
        ...
        private void 修改ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("修改修程信息时发生错误！" + ex.Message, "提示信息");
                return;
            }
        }
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.gridView1.RowCount > 0)
                {
                    ...
                    {
                        if (MessageBox.Show("确认删除修程信息", "确认信息", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.OK)
                        {
